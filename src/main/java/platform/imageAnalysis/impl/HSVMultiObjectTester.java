...
public class HSVMultiObjectTester extends ImageProcessor {
    ...
    public AnalysisResult performProcessing(String cameraId, BufferedImage bufferedImage, Map<String, Object> additionalIntAttr){
        ...
        if (additionalIntAttr.get("MIN_SIZE") != null){
        ...
        System.out.println("Hue is: " + val + " to " +( val +10));
        opencv_core.inRange(hsv, new opencv_core.Mat(1, 1, CV_32SC4, new opencv_core.Scalar(val, S_MIN, V_MIN, 0)), new opencv_core.Mat(1, 1, CV_32SC4, new opencv_core.Scalar(val + 10, S_MAX, V_MAX, 0)), mask);
