package platform.core.imageAnalysis.impl.components;
...
import com.sun.image.codec.jpeg.*;
 ...
 public class ImageCompare {
	...
	public static void main(String[] args) {
		...
		ImageCompare ic = new ImageCompare("src//main//resources//testImages//result.jpg", "src//main//resources//testImages//panorama_image1.jpg");
	...
	public float compare() {
		...
		float totalComparisons = comparex * comparey;
		float correctComparisons = 0;
		...
		return (float)correctComparisons/totalComparisons;
	}
